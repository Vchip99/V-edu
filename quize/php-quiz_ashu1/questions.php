	    ...
	    <div class ="col-sm-9">
			<div class="panel panel-info" >
			   ...
			   <div class="panel-heading" style="background:#ADD8E6" align ="right">
					 ...
					 <button type="button" class="btn"><b>Timer : <span id='timer'></span></b></button >&emsp;&emsp;&emsp;								
					</div>
							  ...
							  <?php 
								$i++;
									if ( $k == 1 ) {
										...
										<button id='".$j."' class='next btn btn-success' type='button'>Next</button>&emsp; 
						                <button  id='".$j."' class='clear btn btn-success' type='button'>clear response</button>&emsp; 
						                <button  id='".$j."' class='mark btn btn-success' type='button'>Mark for Review and Next</button>";

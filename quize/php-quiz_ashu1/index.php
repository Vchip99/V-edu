...
<html lang="en">
  ...
  <body>
	<div class="container">
		<Center><?php require_once 'templates/ads.php';?></center>
		<div class="login-form">
			...
			<form id="login-form" method="post" class="form-signin" role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>">
				...
				<?php /*?><select class="form-control" name="technology" id="technology" required>
...
?>					
			...
			<div class="text-center well">
				<p>Demo Email/Password: vchip@gmail.com/chand</p>
			</div>
		</div>
	</div>
	<!-- /container -->
